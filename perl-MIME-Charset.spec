...
Version  : 1.013
Release  : 20
URL      : https://cpan.metacpan.org/authors/id/N/NE/NEZUMI/MIME-Charset-1.013.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/N/NE/NEZUMI/MIME-Charset-1.013.tar.gz
...
%prep
%setup -q -n MIME-Charset-1.013
cd %{_builddir}
tar xf %{_sourcedir}/libmime-charset-perl_1.012.2-1.debian.tar.xz
cd %{_builddir}/MIME-Charset-1.013
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/MIME-Charset-1.013/deblicense/
...
cp %{_builddir}/MIME-Charset-%{version}/COPYING %{buildroot}/usr/share/package-licenses/perl-MIME-Charset/4cc77b90af91e615a64ae04893fdffa7939db84c
